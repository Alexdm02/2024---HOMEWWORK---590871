...
public class Labirinto {
	...
	public static class LabirintoBuilder{
		...
		public LabirintoBuilder addAdiacenza(String stanza, String stanzaAdiacente, Direzioni direzione){
		...
		public LabirintoBuilder addStanzaBloccata(String stanza, Direzioni direzione, String attrezzo) {
		...
		public LabirintoBuilder  addCane(String nome, String presentazione, Attrezzo a) {
			Cane c = new Cane(nome, presentazione, a);
			if(this.ultimaStanzaAggiunta==null)
				return this;
	...
	public static class LabirintoBuilder {
		...
		public LabirintoBuilder addStanzaBloccata(String nome, String attrezzoSbloccante, String direzioneBloccata) {
			Stanza stanza = new StanzaBloccata(nome, Direzioni.valueOf(direzioneBloccata), attrezzoSbloccante);
			this.UltimaStanzaAggiuntaEAggiorna(stanza);
			return this;
		}
